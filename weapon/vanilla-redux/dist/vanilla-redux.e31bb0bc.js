...
var btnDecrease = document.querySelector('#decrease'); // 액션의 타입(이름)과 생성 함수 정의

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 객체를 만드는 액션 생성 함수를 작성
...
var store = (0, _redux.createStore)(reducer); // render 함수 만들기 - 상태 업데이트될 때마다 호출됨.
...
render(); // 상태 바뀔 때마다 방금 만든 render함수가 호출되도록 함. 내장함수 subscribe 이용

store.subscribe(render); // 액션 발생시키기 == dispatch. 파라미터는 액션 객체를 넣어준다.
